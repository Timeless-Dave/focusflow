...
/** Inline Feather-style SVGs (replacing react-icons). */
...
function CarouselItem({ item, index, itemWidth, round, trackItemOffset, x, transition }) {
  ...
  return (
    <motion.div
      ...
      className={`carousel-item ${round ? 'round' : ''}${item.image ? ' carousel-item--with-image' : ''}`}
      style={{
        width: itemWidth,
    ...
    >
      {item.image ? (
        <>
          <div className="carousel-item-image carousel-item-image--cover">
...
export default function Carousel({
  ...
  const effectiveWidth = Math.max(280, Math.min(baseWidth, containerWidth));
